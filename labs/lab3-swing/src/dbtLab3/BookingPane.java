...
public class BookingPane extends BasicPane {
	...
	private void fillNameList() {
		...
		List<String> movieNames = db.getMovieNames();
	...
	private void fillDateList() {
		...
		List<String> perfDates = db.getPerformanceDates(movieName);
		for(String date : perfDates){
	...
	class NameSelectionListener implements ListSelectionListener {
		...
		public void valueChanged(ListSelectionEvent e) {
			...
			//String movieName = nameList.getSelectedValue();
			fillDateList(); //send in movie name?
		}
	}
	...
	class DateSelectionListener implements ListSelectionListener {
		...
		public void valueChanged(ListSelectionEvent e) {
			...
			fields[MOVIE_NAME].setText(perf.getMovie());
            fields[PERF_DATE].setText(perf.getShowdate());
            fields[THEATER_NAME].setText(perf.getTheater());
            fields[FREE_SEATS].setText(String.valueOf(perf.getNbrSeats()));
		}
	}
	...
	class ActionHandler implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (db.makeReservation(movieName, date)) {
				displayMessage("Ticket successfully booked. Your reservation number is ...");
				Performance perf = db.getPerformance(movieName, date);
				fields[FREE_SEATS].setText(String.valueOf(perf.getNbrSeats()));
			} else {
				displayMessage("Could not book ticket. No seats left.");
			}
		}
	}
}
